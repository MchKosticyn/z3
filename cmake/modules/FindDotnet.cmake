...
FUNCTION(DOTNET_GET_DEPS _DN_PROJECT arguments)
    ...
    IF(_DN_NETCOREAPP)
        SET(_DN_BUILD_OPTIONS -f netcoreapp6.0)
        SET(_DN_PACK_OPTIONS /p:TargetFrameworks=netcoreapp6.0)
    ELSEIF(UNIX)
        # Unix builds default to netcoreapp6.0
        SET(_DN_BUILD_OPTIONS -f netcoreapp6.0)
        SET(_DN_PACK_OPTIONS /p:TargetFrameworks=netcoreapp6.0)
    ENDIF()
...
FUNCTION(TEST_DOTNET DOTNET_PROJECT)
    ...
    ELSE()
        SET(test_framework_args -f netcoreapp6.0)
    ENDIF()
